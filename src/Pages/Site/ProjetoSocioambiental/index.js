        ...
        <div>
            ...
            <Container style={{ paddingTop: 20}}>
                <Center>
                    ...
                    <TextSection columns="1">
                        <p>
                        Entre agosto e o começo de setembro de 2021, o Semasa, por meio do Trabalho Técnico Socioambiental, 
                        realizou as ações de sensibilização ambiental e arborização urbana junto aos moradores dos bairros beneficiados 
                        pelas obras do Complexo Viário Cassaquera.
                        </p>
                        <p>
                        Crianças, jovens, professores e profissionais de creches e escolas estaduais e municipais, além de agentes de saúde da US 
                        (Unidade da Saúde) Centreville, participaram do plantio de 130 mudas nativas da Mata Atlântica. Antes de colocarem a mão na 
                        terra e dar uma nova vida às árvores, os participantes aprenderam sobre os benefícios das árvores para o meio ambiente e a saúde, 
                        como é realizado um plantio responsável e quais cuidados devem ser adotados para que as mudas se desenvolvam de forma saudável.  
                        </p>
                        <p>
                        As espécies que ganharam novos lares são: ipê-amarelo, pêssego-do mato, uvaia, cereja do rio grande, araçá, tarumã, 
                        jacarandá-mimoso, guaçatonga, cabeludinha e chupa-ferro. Para que as árvores se desenvolvam e cresçam saudáveis, o Semasa irá 
                        realizar o acompanhamento e monitoramento das mudas durante o período de seis meses, em parceria com os moradores que fizeram 
                        parte das atividades.   
                        </p>
                        <p>
                        As ações contaram com apoio das secretarias de Meio Ambiente, Educação, Saúde e Mobilidade Urbana. Confira os locais que 
                        ficaram mais verdes e arborizados. 
                        </p>
                    </TextSection>
                </Center>  
            </Container>
                    ...
                    <TableContainer component={Paper}>
                        <Table className={classes.table} aria-label="customized table">
                            ...
                            <TableRow>
                                ...
                                <StyledTableCell align="center">Locais beneficiados</StyledTableCell>
                                <StyledTableCell align="center">Plantio das mudas</StyledTableCell>
                                <StyledTableCell align="center">Quantidade</StyledTableCell>
                            </TableRow>
                            </TableHead>
                            <TableBody>
                            {/* {rows.map((row) => (
                                <StyledTableRow key={row.bairro}>
                                <StyledTableCell align="center" component="th" scope="row">
                                    {row.identificacao}
                                </StyledTableCell>
                                <StyledTableCell align="center">{row.bairro}</StyledTableCell>
                                <StyledTableCell align="center" >{row.rua}</StyledTableCell>
                                <StyledTableCell align="center">{row.mudas}</StyledTableCell>
                                </StyledTableRow>
                            ))} */}
                                
                                <StyledTableRow>
                                    <StyledTableCell align="center" rowSpan={5}>Marek</StyledTableCell>
                                    <StyledTableCell align="center" rowSpan={3}>
                                        Creche Adalgisa Boccacino
                                    </StyledTableCell>
                                    
                                    <StyledTableCell align="center" >R. Natalino Lamberti, 116</StyledTableCell>
                                    <StyledTableCell align="center" rowSpan={3}>25</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>
                                    <StyledTableCell align="center" >R. Luís Gomes Pain, 256</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>
                                    <StyledTableCell align="center" >R. Natalino Lamberti, 74</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>                    
                                    ...
                                    <StyledTableCell align="center" >R. Eng. Alfred Heitzman Júnior</StyledTableCell>
                                    <StyledTableCell align="center" rowSpan={2}>21</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>                    
                                    <StyledTableCell align="center">
                                        CEU Marek
                                ...
                                <StyledTableRow>
                                    ...
                                    <StyledTableCell align="center" >Av. Queiróz Filho, 1640</StyledTableCell>
                                    <StyledTableCell align="center">19</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>
                                    <StyledTableCell align="center" rowSpan={2}>Centreville</StyledTableCell>
                                    <StyledTableCell align="center">
                                        E.E. 16 de Julho
                                    </StyledTableCell>
                                    
                                    <StyledTableCell align="center" >R. Gel Olímpio Mourão Filho</StyledTableCell>
                                    <StyledTableCell align="center" rowSpan={2}>12</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>
                                    <StyledTableCell align="center">
                                     UBS Centreville
                                    ...
                                    <StyledTableCell align="center" >R. Bezerra de Menezes, 35</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>
                                    <StyledTableCell align="center" rowSpan={3}>Guarani</StyledTableCell>
                                    <StyledTableCell align="center">
                                    E.E. Homero Thon
                                    </StyledTableCell>
                                    
                                    <StyledTableCell align="center" >Av. Pedro Américo, 1705</StyledTableCell>
                                    <StyledTableCell align="center" rowSpan={3}>26</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>
                                    ...
                                    <StyledTableCell align="center" >R. Dom Aquino, 1</StyledTableCell>
                                </StyledTableRow>
                                <StyledTableRow>
                                    
                                    <StyledTableCell align="center" >R. Caraíbas, 30</StyledTableCell>
                                </StyledTableRow>

                                <StyledTableRow>
                                    <StyledTableCell align="center" rowSpan={2}>Homero Thon</StyledTableCell>
                                    <StyledTableCell align="center">
                                        EMEIEF Homero Thon
                                    </StyledTableCell>
                                    
                                    <StyledTableCell align="center" >Av. Tibiriçá, 555</StyledTableCell>
                                    <StyledTableCell align="center" rowSpan={2}>13</StyledTableCell>
                                </StyledTableRow>
                                ...
                                <StyledTableRow>
                                    ...
                                    <StyledTableCell align="center" >Av. Capuava, 913</StyledTableCell>
                                </StyledTableRow>
                                ...
                                <StyledTableRow>
                                    ...
                                    <StyledTableCell align="center" >R. Agostinho de Campos, 80</StyledTableCell>
