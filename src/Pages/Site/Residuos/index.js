      ...
      <Container>
        ...
        <Center>
          ...
          >
            ...
            <p style={{ textAlign: "justify" }}>
              • Reduzir a quantidade de materiais secos que são aterrados e
              ampliar a vida útil do Aterro Sanitário Municipal. A previsão é de
            ...
            <p style={{ textAlign: "justify" }}>
              ...
              (confira abaixo a localização dos ecopontos). O prazo de execução
              das obras é de dois meses. Só na região dessas três unidades, a
              equipe de varrição do Semasa gastou, em todo o ano de 2021, mais
              de R$ 141 mil para limpar pontos de descarte irregular de
              resíduos. Foram retiradas 680 toneladas de materiais.
            </p>
            <p style={{ textAlign: "justify" }}>
              ...
              definido. Contando com as 10 Estações de Coleta que vão ser
              implantadas, o Semasa pode economizar mais de R$ 500 mil por ano,
              caso consiga combater pontos de descarte irregular. O investimento
              para construir as 10 Estações de Coleta é de mais de R$ 6 milhões.
            </p>
            <p style={{ textAlign: "justify" }}>
              <strong>Modernização dos equipamentos </strong>
            </p>
            <p style={{ textAlign: "justify" }}>
              As novas Estações de Coleta serão mais modernas. As unidades vão
              ...
              resíduos às cooperativas de reciclagem. Além disso, os
              funcionários que trabalham nos ecopontos ganharão tablets ou
              celulares para fazer controle das pessoas que acessam as Estações
              de Coleta. Atualmente, o serviço é feito a mão. Todos os
              equipamentos ainda terão um sistema de filmagem de qualidade para
              monitorar os locais e evitar depredações, furtos e invasões. O
              monitoramento ocorrerá em um{" "}
            ...
            <p style={{ textAlign: "justify" }}>
              Outra importante obra para a gestão de resíduos sólidos é a
              implantação de uma nova Central de Triagem de Resíduos
              Recicláveis, local para abrigar as duas cooperativas de reciclagem
              que existem em Santo André. O espaço também será mais moderno,
              oferecendo equipamentos e estrutura mais adequados aos cooperados
              que fazem a triagem, compactação e venda de resíduos secos.
              Atualmente, mais de 100 pessoas trabalham na Central de Triagem
              que existe dentro do Aterro Sanitário Municipal. O novo galpão,
