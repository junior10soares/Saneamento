    ...
    <div>
      ...
      <Container>
        <Center>
          ...
          <TextSection columns="1">
            <p>
              Em março de 2022, o Semasa começou o Projeto de Trabalho Técnico
              Socioambiental das obras das Estações de Coleta. A iniciativa
              visa:
            </p>
          </TextSection>
      ...
      <Container style={{ paddingTop: "0px", marginTop: "-50px" }}>
        <Center>
          <TextSection columns="1">
            <p>
              O projeto iniciou no Jardim Ana Maria com uma mobilização porta a
              porta para compreender percepções e comportamentos da população
              sobre a gestão de resíduos sólidos e o descarte correto no
              município.
            </p>
            <p>
              Agentes devidamente identificados passam de casa em casa para
              efetuar uma pesquisa e entregar materiais educativos e com
              informações sobre as obras e os serviços da área de resíduos,
              executados pelo Semasa.
            </p>
          </TextSection>
      ...
      <Container style={{ paddingTop: 0, marginTop: "-40px" }}>
        <Center>
          <TextSection columns="1">
            <p>
              O questionário possui perguntas sobre problemas que o munícipe
              identifica no seu bairro, quais tipos de resíduos ele gera em
              maior quantidade, como é feito o descarte dos materiais –
              inclusive de resíduos volumosos e perigosos (como lâmpadas, pilhas
              e baterias), dentre outros.
            </p>
            <p>
              Com o resultado da pesquisa, o Semasa poderá compreender as
              necessidades, carências e dificuldade da população, o que é um
              importante instrumento para planejar e implementar atividades de
              sensibilização e educação ambiental, além de promover melhorias, o
              que corrobora com as diretrizes e os objetivos da Política
      ...
      <Container style={{ paddingTop: 0, marginTop: "-40px" }}>
        <Center>
          <TextSection columns="1">
            <p>
              Além do Jardim Ana Maria, os bairros Jardim, Bangu, Centro, Jardim
              Alvorada, Jardim Cristiane, Jardim Santo André, Parque Miami, Vila
              Guiomar e Vila Linda também vão ser beneficiados com uma Estação
              de Coleta para a população descartar corretamente resíduos
              volumosos, como recicláveis, entulho, pneus, resíduos eletrônicos
              (fogão, geladeira, monitor), colchões, estofados, poda de árvore,
              dentre outros.
            </p>
            <p>
              O Semasa realizará diversas atividades e visitas ao Aterro
              Sanitário Municipal e às cooperativas de reciclagem do município.
              Para otimizar ainda mais a gestão de resíduos sólidos, as pessoas
              que trabalham nas cooperativas, catadores autônomos de recicláveis
              e zeladores dos ecopontos também participarão de cursos e
              capacitações. O Projeto de Trabalho Técnico Socioambiental terá
              duração de 7 meses, com investimento de mais de R$ 600 mil.
            </p>
          </TextSection>
        </Center>
      </Container>
