...
import Microrreservatorios from "../Pages/Site/Microrreservatorios";
...
import Fluviometros from "../Pages/Site/Fluviometros";
...
const Routes = () => {
  return (
    <Switch>
      ...
      <Route
        exact
        path="/microrreservatorios"
        component={Microrreservatorios}
      />
      ...
      />
      <Route exact path="/fluviometros" component={Fluviometros} />
      <Route
        exact
        path="/projeto-socioambiental"
        component={ProjetoSocioambiental}
      />
      <Route
        exact
        path="/projeto-trabalho-tecnico"
        component={ProjetoTrabalhoTecnico}
      />
      ...
      <Route
        exact
        path="/sistemas-monitoramento"
        component={SistemaMonitoramento}
      />
      <Route
        exact
        path="/estacao-meteorologicas"
        component={EstacaoMeteorologicas}
      />
      <Route
        exact
        path="/bueiros-inteligentes"
        component={BueirosInteligentes}
      />
      ...
      <Route
        exact
        path="/painel/fase-obra/edit/:id"
        component={PhaseWorkEdit}
      />
    </Switch>
  );
};
